...
public class Spindexer extends SubsystemBase 
{
    ...
    private static final double SENSOR_TO_MECHANISM_RATIO = (1.0 / 4.0) * (24.0 / 26.0);  // 1/4 Sport, 24/26 pulleys
    ...
    private static final double MAX_SPINDEX_SPEED_RPS = Constants.Spindexer.MAX_SPINDEX_SPEED_RPS; // TODO - tune
    ...
    private static final double MM_ACCEL_RPS2 = 100.0;
